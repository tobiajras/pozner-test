  ...
  return (
    ...
    >
      <div className='flex flex-col items-center gap-10 sm:gap-16 md:gap-10 w-full'>
        ...
        >
          <div className='bg-color-primary-dark/80 md:bg-transparent px-5 py-8 sm:py-10 md:px-0 max-w-[320px] sm:max-w-[350px] md:max-w-full w-full flex gap-5 lg:gap-10 justify-center items-center md:py-20 relative rounded md:rounded-none overflow-hidden'>
        ...
        >
          <div className='bg-color-primary-dark/80 md:bg-transparent px-5 py-8 sm:py-10 md:px-0 max-w-[320px] sm:max-w-[350px] md:max-w-full w-full flex gap-5 lg:gap-10 justify-center items-center md:py-20 relative rounded md:rounded-none overflow-hidden'>
            ...
            <div className='max-w-[320px] sm:max-w-[350px] md:max-w-full md:w-[400px] lg:w-[600px]'>
              ...
              <div className='flex flex-col gap-4 md:text-lg lg:text-lg w-full max-w-[380px] sm:max-w-max sm:w-[310px] md:w-[350px] lg:w-[500px]'>
                <p className='text-color-text-light md:text-color-text'>
                  Deleitate con nuestros irresistibles postres. Desde clásicos
                  que enamoran hasta creaciones únicas, cada bocado es una dulce
